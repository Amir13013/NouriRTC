...
export const authenticate = (req, res, next) => {
  ...
  // le header ressemble à "Bearer xxxxx"
  // "Bearer" c'est juste le mot-clé HTTP standard pour dire "voilà mon token"
  // je split sur l'espace et je prends l'index [1] → juste la partie token
