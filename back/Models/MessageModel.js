...
export const editMessageService = async (messageId, userId, newContent) => {
  ...
  // userId from JWT is a number, message.userId stored as String in MongoDB — compare as strings
...
export const toggleReactionService = async (messageId, userId, emoji) => {
  ...
  // Always work with string userId — MongoDB stores users as String[], JWT gives us a number
